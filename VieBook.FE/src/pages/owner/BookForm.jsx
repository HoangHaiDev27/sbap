...
export default function BookForm() {
  ...
  const validate = () => {
    ...
    if (form.uploaderType === "Seller" && !form.certificateFile) {
      errs.certificate =
        "Giấy chứng nhận bản quyền là bắt buộc đối với Chủ shop";
    }
    return errs;
  };
    ...
    <div className="bg-slate-800 p-8 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <button
          onClick={() => {
            const fullName =
              userProfile?.profile?.fullName || userProfile?.email || "Tác giả";
            setForm((prev) => ({
              ...prev,
              uploaderType: "Owner",
              author: fullName,
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">
              Bạn là tác giả của cuốn sách này. Tên tác giả sẽ tự động được gán
              theo tên của bạn.
            </p>
          </div>
        </button>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">
              Bạn bán sách của tác giả khác. Cần cung cấp mã ISBN và giấy chứng
              nhận bản quyền.
            </p>
          </div>
        </button>
          ...
          <div className="text-center">
            ...
            <div className="mt-4 text-sm text-gray-300 bg-gray-700 p-3 rounded">
              <p className="font-medium">
                Trạng thái: Chờ đăng chương • Đang ra
              </p>
              <p className="text-xs mt-1">
                Bạn có thể đăng chương dần dần. Sách sẽ cần kiểm duyệt để hiển
                thị lên web.
              </p>
            </div>
          </div>
        ...
        >
          <div className="text-center">
            ...
            <div className="mt-4 text-sm text-gray-300 bg-gray-700 p-3 rounded">
              ...
              <p className="text-xs mt-1">
                Cần đăng hết chương mới có thể kiểm duyệt để hiển thị lên web.
              </p>
            </div>
          </div>
        </button>
  ...
  const renderStep3 = () => (
    <div className="bg-slate-800 p-6 rounded-lg shadow-lg">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          >
            <span className="text-lg">
              {form.uploaderType === "Owner" ? "✍️" : "🏪"}
            </span>
            <span>
              {form.uploaderType === "Owner" ? "Tác giả" : "Chủ shop"}
            </span>
          </div>
          ...
          >
            ...
            <span>
              {form.uploadStatus === "Full" ? "Đã trọn bộ" : "Chưa trọn bộ"}
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {form.uploaderType === "Owner" && (
          <div>
            ...
            />
            {errors.isbn && (
              <p className="text-red-400 text-sm mt-1">{errors.isbn}</p>
            )}
          </div>
        )}
        ...
        <div className="relative">
          ...
          {errors.categoryIds && (
            <p className="text-red-400 text-sm mt-1">{errors.categoryIds}</p>
          )}
        </div>
      </div>
      ...
      <div className="mt-6">
        ...
        {errors.cover && (
          <p className="text-red-400 text-sm mt-2">{errors.cover}</p>
        )}
      </div>
          ...
          >
            {certificatePreview ? (
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Click để chọn file giấy chứng nhận
                </p>
          ...
          <div className="bg-slate-800 rounded-xl p-8 max-w-md w-full mx-4 shadow-2xl border-2 border-green-500">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-400">
                Bạn đã tạo sách thành công. Hãy tiếp tục bằng cách đăng chương
                để hoàn thiện sách của bạn.
              </p>
            </div>
