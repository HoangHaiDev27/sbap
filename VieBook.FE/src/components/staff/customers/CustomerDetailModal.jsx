  ...
  useEffect(() => {
    const loadSubscription = async () => {
      try {
        ...
        const data = await getUserSubscription(customer.userId);
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-lg">
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            <h4 className="text-lg font-medium text-gray-900">{customer.fullName || 'Chưa cập nhật'}</h4>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
            <div className="text-sm text-blue-600 flex items-center mb-1">
              <i className="ri-shopping-cart-line mr-1"></i> Số chương đã mua
            </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg border border-green-200">
            <div className="text-sm text-green-600 flex items-center mb-1">
              <i className="ri-book-2-line mr-1"></i> Số sách đã mua
            </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg border border-purple-200">
            ...
            <div className="text-2xl font-bold text-purple-900">
              {(customer.wallet || 0).toLocaleString()} xu
            </div>
          </div>
          ...
          <div className="flex items-center justify-between py-2 border-b border-gray-200">
            ...
            <span className="text-sm font-medium text-gray-900">
              {customer.lastLoginAt 
                ? new Date(customer.lastLoginAt).toLocaleString('vi-VN', {
                    year: 'numeric',
                    month: '2-digit',
                    day: '2-digit',
                    hour: '2-digit',
