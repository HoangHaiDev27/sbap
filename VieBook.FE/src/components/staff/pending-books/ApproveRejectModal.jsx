      ...
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 w-full max-w-md">
        ...
        {type === "reject" && (
          <textarea
            ...
            className="w-full border border-gray-300 rounded-lg px-3 py-2 mb-4 focus:ring-2 focus:ring-red-500 text-black text-sm sm:text-base"
            rows="3"
            disabled={loading}
          />
        )}
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-2 sm:space-x-3">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-lg border text-gray-700 hover:bg-gray-100 text-sm sm:text-base"
            disabled={loading}
          >
            Hủy
          </button>
