...
export default function AdminHeader() {
  ...
  return (
    <header className="sticky top-0 left-64 right-0 bg-dark border-b border-gray-200 h-16 flex items-center justify-between px-6 z-30">
      {/* Logo / Title */}
      <div className="flex items-center space-x-4">
        <h1 className="text-lg font-semibold text-white-900">Trang quản lí của quản trị viên</h1>
      </div>
        ...
        <div className="relative" ref={userMenuRef}>
          ...
          >
            <img
              ...
              alt="Admin"
            />
            <span className="text-white-900 font-medium">Admin</span>
