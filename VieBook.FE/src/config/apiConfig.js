...
export const API_ENDPOINTS = {
  ...
  // Payment endpoints
  PAYMENT: {
    CREATE_LINK: `${API_BASE_URL}/api/checkout/create-payment-link`,
  ...
  UPLOADPOSTVIDEO: `${API_BASE_URL}/api/upload/postVideo`,
  POSTS: {
    ...
    UPDATE_VISIBILITY: (postId) => `${API_BASE_URL}/api/posts/${postId}/visibility`,
        REACTIONS: {
            GET: (postId) => `${API_BASE_URL}/api/posts/${postId}/reactions`,
            GET_COUNT: (postId) => `${API_BASE_URL}/api/posts/${postId}/reactions/count`,
            GET_USER: (postId) => `${API_BASE_URL}/api/posts/${postId}/reactions/user`,
            TOGGLE: (postId) => `${API_BASE_URL}/api/posts/${postId}/reactions`,
            DELETE: (postId) => `${API_BASE_URL}/api/posts/${postId}/reactions`,
        },
        COMMENTS: {
            GET: (postId) => `${API_BASE_URL}/api/posts/${postId}/comments`,
            GET_COUNT: (postId) => `${API_BASE_URL}/api/posts/${postId}/comments/count`,
            GET_BY_ID: (postId, commentId) => `${API_BASE_URL}/api/posts/${postId}/comments/${commentId}`,
            CREATE: (postId) => `${API_BASE_URL}/api/posts/${postId}/comments`,
            UPDATE: (postId, commentId) => `${API_BASE_URL}/api/posts/${postId}/comments/${commentId}`,
            DELETE: (postId, commentId) => `${API_BASE_URL}/api/posts/${postId}/comments/${commentId}`,
        },
    },
    BOOK_CLAIMS: {
        CREATE: `${API_BASE_URL}/api/posts/claim`,
        GET_BY_OFFER: (offerId) => `${API_BASE_URL}/api/posts/offers/${offerId}/claims`,
        GET_MY_CLAIMS: `${API_BASE_URL}/api/posts/claims/my`,
        GET_BY_ID: (claimId) => `${API_BASE_URL}/api/posts/claims/${claimId}`,
        GET_BY_STATUS: (status) => `${API_BASE_URL}/api/posts/claims/status/${status}`,
        APPROVE: (claimId) => `${API_BASE_URL}/api/posts/claim/${claimId}/approve`,
        UPDATE: (claimId) => `${API_BASE_URL}/api/posts/claim/${claimId}`,
        DELETE: (claimId) => `${API_BASE_URL}/api/posts/claim/${claimId}`,
        HAS_CLAIMED: (offerId) => `${API_BASE_URL}/api/posts/offers/${offerId}/has-claimed`,
    },
    BOOK_OFFERS: {
        GET_BY_ID: (offerId) => `${API_BASE_URL}/api/posts/offers/${offerId}`,
        GET_BY_POST: (postId) => `${API_BASE_URL}/api/posts/${postId}/offer`,
        GET_ACTIVE: `${API_BASE_URL}/api/posts/offers/active`,
        GET_BY_OWNER: (ownerId) => `${API_BASE_URL}/api/posts/offers/owner/${ownerId}`,
        UPDATE: (offerId) => `${API_BASE_URL}/api/posts/offers/${offerId}`,
        DELETE: (offerId) => `${API_BASE_URL}/api/posts/offers/${offerId}`,
    },
  PROMOTIONS: {
