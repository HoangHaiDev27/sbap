...
namespace Services.Interfaces
{
    public interface IPostService
    {
        ...
        Task<List<PostDTO>> GetPostsAsync(string? postType = null, string? searchQuery = null, string? tag = null, int? authorId = null);
        ...
        Task<PostDTO> UpdateVisibilityAsync(long postId, string visibility, int userId);
    }
}
